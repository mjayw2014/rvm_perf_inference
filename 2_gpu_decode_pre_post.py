...
def gpu_decode_pre_post_inference(inputs, outputs, bindings, trt_context, input_video_file):
    ...
    for frame in decoder:
        ...
        # Copy frame to CPU
        checkCudaErrors(cuda.cuMemcpyDtoH(h_out_frame, d_out_frame, d_frame_size))
